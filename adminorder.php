    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>'.$CVV.'</td>
          <td>
            <button type="submit" class="btn btn-outline-success"><a href="update.php?updateid='.$ID.'" class="test-light nav-link">Update Record</a></button>
            <button type="submit" class="btn btn-outline-danger"><a href="deleteorder.php?deleteid='.$ID.'" class="test-light nav-link">Delete Record</a></button>
          </td>
        </tr>
        ';
        }
